...
from mongoengine.django.auth.models import User

from mock import patch

from django_mongo_browserid.base import verify
from django_mongo_browserid.tests import mock_browserid
from django_mongo_browserid.auth import BrowserIDBackend
...
@patch('django_mongo_browserid.auth.BrowserIDBackend.authenticate')
...
@patch('django_mongo_browserid.auth.verify')
...
@patch.object(settings, 'BROWSERID_CREATE_USER',
              'django_mongo_browserid.tests.fake_create_user', create=True)
@patch('django_mongo_browserid.tests.fake_create_user')
