...
from django_mongo_browserid.base import get_audience as base_get_audience, verify
from django_mongo_browserid.signals import user_created
...
def get_audience(*args):
    warn('Deprecated, please use the standalone function '
         'django_mongo_browserid.get_audience instead.', DeprecationWarning)
...
class BrowserIDBackend(object):
    ...
    def verify(self, *args):
        warn('Deprecated, please use the standalone function '
             'django_mongo_browserid.verify instead.', DeprecationWarning)
        return verify(*args)
    ...
    def authenticate(self, assertion=None, audience=None):
        """``mongoengine.django.auth`` compatible authentication method.
        ...
        See django_mongo_browserid.base.get_audience()
        """
